...
export class Pregunta5Component implements OnInit {
  ...
  comprobar() {
    ...
    if (this.seleccion === 'Más de cinco') {
      this.respuestaCorrecta = true;
      this.respuestaIncorrecta = false;
      this.respuestasCorrectas['/zona3/pregunta5'] = true;
  
      // Almacenar estado específico de la pregunta 1
      localStorage.setItem('respuestaCorrectaZona3Pregunta5', 'true');
      ...
      this.respuestasCorrectas['/zona3/pregunta5'] = false;
  
      // Almacenar estado específico de la pregunta 1
      localStorage.setItem('respuestaCorrectaZona3Pregunta5', 'false');
  ...
  ngOnInit() {
    ...
    const respuestaCorrectaZona3Pregunta5 = localStorage.getItem('respuestaCorrectaZona3Pregunta5');
    this.respuestaCorrecta = respuestaCorrectaZona3Pregunta5 === 'true';
