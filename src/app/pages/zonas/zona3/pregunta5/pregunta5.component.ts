...
export class Pregunta5Component implements OnInit {
  ...
  comprobar() {
    ...
    if (this.seleccionZ3 === 'Más de cinco') {
      this.respuestaCorrectaZ3 = true;
      this.respuestaIncorrectaZ3 = false;
      this.respuestasCorrectasZ3['/zona3/pregunta5'] = true;
      ...
      this.respuestasCorrectasZ3['/zona3/pregunta5'] = false;
  
      // Almacenar estado específico de la pregunta 1
      localStorage.setItem('respuestaCorrectaZ3Pregunta5', 'false');
  
      if (this.seleccionZ3 === 'Dos') {
        setTimeout(() => {
  ...
  ngOnInit() {
    ...
    const seleccionZ3GuardadaZ3 = localStorage.getItem('seleccionZ3Pregunta5');
    if (seleccionZ3GuardadaZ3) {
      this.seleccionZ3 = seleccionZ3GuardadaZ3;
    }
  
    // Recuperar el estado específico de la pregunta 1
    const respuestaCorrectaZ3Pregunta5 = localStorage.getItem('respuestaCorrectaZ3Pregunta5');
    this.respuestaCorrectaZ3 = respuestaCorrectaZ3Pregunta5 === 'true';
