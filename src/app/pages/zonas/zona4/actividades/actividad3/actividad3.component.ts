...
export class Actividad3Component {
  ...
  hecho() {
    ...
    respuestasCorrectas['/zona4/actividades/actividad3'] = true;
    localStorage.setItem('respuestasCorrectas', JSON.stringify(respuestasCorrectas));

    this.router.navigate(['/zona4/actividades/actividad3/hecho']);
  }

  fallo() {
    this.router.navigate(['/zona4/actividades/actividad3/fallo']);
  }
}
