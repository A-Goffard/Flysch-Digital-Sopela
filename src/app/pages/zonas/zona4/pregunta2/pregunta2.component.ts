...
export class Pregunta2Component implements OnInit {
  ...
  comprobar() {
    ...
    if (this.seleccionZ4 === 'XXXrespuestacorrecta') {
      ...
      localStorage.setItem('respuestaCorrectaZ4Pregunta2', 'true');
      ...
      this.respuestasCorrectasZ4['/zona4/pregunta2'] = false;
    ...
    localStorage.setItem('seleccionZ4Pregunta2', this.seleccionZ4);
  }
  ...
  ngOnInit() {
    ...
    const seleccionZ4GuardadaZ4 = localStorage.getItem('seleccionZ4Pregunta2');
    if (seleccionZ4GuardadaZ4) {
      this.seleccionZ4 = seleccionZ4GuardadaZ4;
    }
  
    // Recuperar el estado específico de la pregunta 1
    const respuestaCorrectaZ4Pregunta2 = localStorage.getItem('respuestaCorrectaZ4Pregunta2');
    this.respuestaCorrectaZ4 = respuestaCorrectaZ4Pregunta2 === 'true';
