...
export class Actividad4Component {
  ...
  hecho() {
    ...
    respuestasCorrectas['/zona5/actividades/actividad4'] = true;
    localStorage.setItem('respuestasCorrectas', JSON.stringify(respuestasCorrectas));

    this.router.navigate(['/zona5/actividades/actividad4/hecho']);
  }

  fallo() {
    this.router.navigate(['/zona5/actividades/actividad4/fallo']);
  }
}
