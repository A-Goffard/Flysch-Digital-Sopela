...
export class Actividad5Component {
  ...
  hecho() {
    ...
    respuestasCorrectas['/zona5/actividades/actividad5'] = true;
    localStorage.setItem('respuestasCorrectas', JSON.stringify(respuestasCorrectas));

    this.router.navigate(['/zona5/actividades/actividad5/hecho']);
  }

  fallo() {
    this.router.navigate(['/zona5/actividades/actividad5/fallo']);
  }
}
