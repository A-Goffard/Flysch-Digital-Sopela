...
export class Actividad2Component {
  ...
  hecho() {
    ...
    respuestasCorrectas['/zona2/actividades/actividad2'] = true;
    localStorage.setItem('respuestasCorrectas', JSON.stringify(respuestasCorrectas));

    this.router.navigate(['/zona2/actividades/actividad2/hecho']);
  }

  fallo() {
    this.router.navigate(['/zona2/actividades/actividad2/fallo']);
  }
}
